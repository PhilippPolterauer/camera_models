...
pub trait CameraDistortion {
    ...
    fn undistort(&self, ray: &CameraRay) -> CameraRay;
}
...
// impl Distortion<Point> for Pinhole {
//     fn distort(&self, point: &Point) -> CameraRay {
//         let ray = CameraRay::try_from(point).unwrap();
//         self.distort(&ray)
//     }
//     fn undistort(&self, ray: &CameraRay) -> Point {
//         let ray: CameraRay = self.undistort(&ray);
//         Point::new(ray.x(), ray.y(), 1.0)
//     }
// }
...
impl CameraDistortion for Fisheye {
    ...
    fn undistort(&self, _: &CameraRay) -> CameraRay {
        todo!("Fisheye undistortion")
    }
}
